...
<div class="card">
    ...
    <form id="guessForm" action="NumberGuessServlet" method="post">
        <div class="input-row">
            <input type="number" name="guess" id="guessInput" min="1" max="100" required placeholder="Enter your guess..." />
...
<script>
    ...
    form.addEventListener('submit', function () {
        // Add a quick shake every time user guesses
